...
<head>
    ...
    <style>
        .hero-section {
            background: linear-gradient(rgba(5, 81, 41, 0.8), rgba(10, 150, 57, 0.8)), 
        ...
        .type-alumni { background: #e3f2fd; color: #388e3c; }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.php" style="color:green;">
    ...
    <section class="hero-section" id="home">
        <div class="container">
            ...
            <h2 class="h3 mb-4">Student Portal</h2>
            <p class="lead mb-5">System</p>
    ...
    <footer class="bg-dark text-white py-5">
        <div class="container">
            ...
            <div class="text-center">
                <p>&copy; 2026 Sandigan Colleges Incorporated. All rights reserved.</p>
            </div>
        </div>
    </footer>
