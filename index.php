...
<body>
    ...
    <section class="py-5 alumni-assoc-section">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="content-card text-center">
                        <span class="pill">JOIN OUR COMMUNITY</span>
                        <h2 class="section-title mt-4 mb-3">Ready to Join Sandigan Colleges?</h2>
                        <p class="muted lead-copy">Welcome to the open enrollment period at Sandigan Colleges, Inc.! We are excited to have you join us for another academic year. To help you through the process, we've created a smooth enrollment experience.</p>
                        <div class="mt-4">
                            <a href="index.php" class="btn btn-success btn-lg" style="padding: 12px 40px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 12px rgba(31, 109, 58, 0.2); transition: all 0.3s ease;">
