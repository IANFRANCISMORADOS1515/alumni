...
<head>
    ...
    <title>SCI Management - SCI Alumni System</title>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-sm me-3">
                                                                ...
                                                                <?php else: ?>
                                                                    <img src="default/default-alumni.png" alt="Default Profile" class="avatar-img rounded-circle" style="width: 40px; height: 40px; object-fit: cover;" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="imagePreview" class="mt-2" style="display: none;">
                                <img id="preview" src="default/default-alumni.png" alt="Preview" style="max-width: 150px; max-height: 150px; object-fit: cover; border-radius: 8px;">
                            </div>
                        </div>
                    </div>
        ...
        success: function(data) {
            try {
                if (data && typeof data === 'object') {
                    ...
                    if (data.profile_picture && data.profile_picture !== 'default/default-alumni.png') {
